...
describe('compileTruthyCss', function() {
  ...
  describe('include', function() {
    it('should not throw an error if the output include the input', function() {
      funcResult.include('.test{content:10}');
    });

    it('throws an error if the output does not include the input', function() {
      assert.throws(function() { funcResult.include(20); });
    });
  });
});
